            ...
            <div class="d-flex align-items-stretch overflow-auto pt-3 pt-lg-0">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-50"
                    ...
                    <div class="menu-item px-2">
                        @php
                            if (Auth::user()->role == 'fasilitator') {
                                $route = route('fasilitator');
                            } elseif (Auth::user()->role == 'pendamping') {
                                $route = route('pendamping');
                            } else {
                                $route = route('admin');
                            }
                        @endphp
                        <a href="{{ $route }}" class="menu-link px-5">
                    ...
                    @if (Auth::user()->role == 'fasilitator')
                        <!--begin::Menu item-->
                        <div class="menu-item px-2">
                            <a href="{{ route('fasilitator.listdesa') }}" class="menu-link px-5">
                    ...
                    @elseif (Auth::user()->role == 'pendamping')
                        <!--begin::Menu item-->
                        <div class="menu-item px-2">
                            <a href="{{ route('pendamping.listkegiatan') }}" class="menu-link px-5">
                                <i class="ki-outline ki-colors-square me-2 fs-4"></i>
                                Pra Pemicuan
                            </a>
                        </div>
                        <!--end::Menu item-->
                        ...
                        <div class="menu-item px-2">
                            <a href="{{ route('fasilitator.listdesa') }}" class="menu-link px-5">
                                <i class="ki-outline ki-cheque me-2 fs-4"></i>
                                Pemicuan
                            </a>
                        </div>
                        <!--end::Menu item-->
                        ...
                        <div class="menu-item px-2">
                            <a href="{{ route('fasilitator.listdesa') }}" class="menu-link px-5">
                                <i class="ki-outline ki-parcel me-2 fs-4"></i>
                                Pasca Pemicuan
                            </a>
                        </div>
                        <!--end::Menu item-->
